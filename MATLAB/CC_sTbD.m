...
load('CC_sTbD_data.mat')

% List out each individual parameters
length_1 = CC_sTbD_data(:,2);
length_2 = CC_sTbD_data(:,3);
lig_1 = CC_sTbD_data(:,4);
lig_2 = CC_sTbD_data(:,5);
lig_3 = CC_sTbD_data(:,6);
burst_time = CC_sTbD_data(:,7);
...
xlabel('${(a_1/t)^{0.621}(a_2/t)^{0.243}(l_1/t)^{-0.269}(l_2/t)^{-0.395}}$','interpreter','latex')
