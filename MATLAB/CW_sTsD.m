...
lig_1 = CW_sTsD_data(:,5);
burst_time = CW_sTsD_data(:,6);
...
% Reference burst pressure for pipe with only wall loss corrosion
pb_w_2 = 78;
pb_w_3 = 77.22;
pb_w_4 = 76.64;
pb_w_5 = 74.88;
pb_w = [pb_w_2, pb_w_3, pb_w_4, pb_w_5];
...
if switch_linplt
    ...
    xlabel('${(d/t)^{0.543}(a/t)^{0.157}(l/t)^{-0.323}}$','interpreter','latex')
    ylabel('Normalized burst pressure')
    set(gca,'FontSize',40)
    set(gca,'YColor','k')
    set(gca,'LineWidth',2);
